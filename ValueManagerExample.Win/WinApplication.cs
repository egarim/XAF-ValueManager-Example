...
namespace ValueManagerExample.Win {
    ...
    public partial class ValueManagerExampleWindowsFormsApplication : WinApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static ValueManagerExampleWindowsFormsApplication() {
        ...
        #endregion
        public ValueManagerExampleWindowsFormsApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void ValueManagerExampleWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
